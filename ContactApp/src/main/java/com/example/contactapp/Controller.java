...
public class Controller {
    ...
    public void initialize() {
        contacts.add(new Contact("Bahrom", "Saidashurov", "bahrom.saidashurov_2026@ucentralasia.org", "+90000000", "00001234"));
        contacts.add(new Contact("Akobir", "Berdov", "AKBerdov@gmail.com", "+100000000", "123400"));
